...
class pedidoApi implements IApiUsable
{
    ...
    public function TraerTodosFinalizados($request, $response, $args)
    {
   	...
   	public function TraerTodos($request, $response, $args){
        ...
        {
            case "mozos":
                $pedidos = pedido::where('tipo', 'mozos')->get();
            break;
            case "cerveceros":
                $pedidos = pedido::where('tipo', 'cerveceros')->get();
            break;
            case "bartender":
                $pedidos = pedido::where('tipo', 'bartender')->get();
            break;
            case "cocineros":
                $pedidos = pedido::where('tipo', 'cocineros')->get();
            break;
            default:
                $pedidos = pedido::all();
            break;
